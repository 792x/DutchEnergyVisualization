import {Model, Column, PrimaryKey, Table, CreatedAt, UpdatedAt, AutoIncrement, Unique, ForeignKey, DataType} from "sequelize-typescript";

@Table
export default class Gas extends Model<Gas> {
